...
public class Ejercicio1 {
    ...
    public static void main(String[] args) {
        ...
        CadenaServicio fr = new CadenaServicio();
        Cadena fra = fr.crearFrase();
        
        fr.mostrarVocales(fra);
        fr.invertirFrase(fra);
        fr.vecesRepetido(fra);
        System.out.println("Ingrese una nueva frase: ");
        String frase2= input.nextLine();
        fr.compararLongitud(fra,frase2);
        fr.unirFrases(fra, frase2);
        fr.reemplazar(fra);
        System.out.println(fr.contiene(fra));
